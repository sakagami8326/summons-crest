...
ok(/data-youtube-player data-video-id="oaXxeKBLuVE"[\s\S]*gameplay-youtube-pv-20260917\.jpg/.test(html), 'gameplay section uses the requested YouTube PV with its local poster');
