(() => {
  ...
  function footer() { return `<footer class="footer"><div class="link-row"><a href="/" ${embedded?'target="_top"':''}>公式ホームページ</a><a href="/rules" target="_blank" rel="noopener">遊び方・ルール</a>${device==='tablet'?'<button class="text-button role-change" data-action="role">端末の役割を変更</button>':''}</div></footer>`; }
