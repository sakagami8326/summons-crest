...
ok(/const VERSION = '1\.58'/.test(serverSource) && require('./package.json').version === '1.58.0', 'v1.54 site pages remain covered by v1.58');
...
(async () => {
  ...
  try {
    ...
    ok(catalog.version === '1.58', 'catalog identifies current release');
