// v1.07 regression: territory economy and fixed-plus-variable castle land bonus.
const fs = require('fs');
...
eq(G.CASTLE_LAND_RATE, 0.1, 'castle territory bonus rate');
eq(G.castleLandBonus(600), 160, '600G territory value returns fixed 100 plus 10%');
eq(G.castleLandBonus(105), 111, 'fractional 10% result is rounded');
